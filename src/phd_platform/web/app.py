...
def create_app() -> FastAPI:
    ...
    # Register routes
    from phd_platform.web.routes import pages, placement, assessment, tutoring, lectures, capstone, defense, courses, graph
    ...
    app.include_router(capstone.router, prefix="/capstone")
    app.include_router(defense.router, prefix="/defense")
